...
const OurServices = () => (
  <div className={styles.outServices}>
    <div className={styles.outServices__title}>Наши сервисы</div>
    <div className={styles.outServices__list}>
      {list.map((el, index) => (
        <div className={styles.outServices__item} key={`${el.name}_${index + 1}`}>
